            ...
            ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                        ...
                        <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                            <li class="chapter inner">
                                <div class="simple menu-toggler" data-toggle="collapse"
                                    ${ isNormalMode ? 'data-target="#components-links-module-AppModule-756cfddb190ac60718c7ae51827db382"' : 'data-target="#xs-components-links-module-AppModule-756cfddb190ac60718c7ae51827db382"' }>
                                    <span class="icon ion-md-cog"></span>
                                    <span>Components</span>
                                    <span class="icon ion-ios-arrow-down"></span>
                                </div>
                                <ul class="links collapse"
                                    ${ isNormalMode ? 'id="components-links-module-AppModule-756cfddb190ac60718c7ae51827db382"' : 'id="xs-components-links-module-AppModule-756cfddb190ac60718c7ae51827db382"' }>
                                        <li class="link">
                                            <a href="components/AppComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules">AppComponent</a>
                                        </li>
                                        <li class="link">
                                            <a href="components/ChangePasswordChallengeComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules">ChangePasswordChallengeComponent</a>
                                        </li>
                                        <li class="link">
                    ...
                    <li class="link">
                        <a href="modules/PagesModule.html" data-type="entity-link">PagesModule</a>
                            <li class="chapter inner">
                                <div class="simple menu-toggler" data-toggle="collapse"
                                    ${ isNormalMode ? 'data-target="#components-links-module-PagesModule-cacdb5002de9cca771368cbc2c3f50cd"' : 'data-target="#xs-components-links-module-PagesModule-cacdb5002de9cca771368cbc2c3f50cd"' }>
                                    <span class="icon ion-md-cog"></span>
                                    <span>Components</span>
                                    <span class="icon ion-ios-arrow-down"></span>
                                </div>
                                <ul class="links collapse"
                                    ${ isNormalMode ? 'id="components-links-module-PagesModule-cacdb5002de9cca771368cbc2c3f50cd"' : 'id="xs-components-links-module-PagesModule-cacdb5002de9cca771368cbc2c3f50cd"' }>
                                        <li class="link">
                                        ...
                                        <li class="link">
                                            <a href="components/DoctorComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules">DoctorComponent</a>
                                        </li>
                                        <li class="link">
